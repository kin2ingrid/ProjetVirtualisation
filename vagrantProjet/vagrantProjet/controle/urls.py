...
urlpatterns = [
    ...
    path('editagence/<str:NoAgence>', views.editagence, name='editagence'),
    path('editagent/<str:matricule>', views.editagent, name='editagent'),
    path('editappro/<int:id>', views.editappro, name='editappro'),
    path('editcaisse/<str:noCaisse>', views.editcaisse, name='editcaisse'),
